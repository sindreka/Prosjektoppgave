...
if 0 %convergencekriteria: ant vs tol for different m, function 1 % Merkelig
    ...
    for i = p
            utdata1(j,:) = seriell( 10,k,1,1,1,i);
            utdata2(j,:) = seriell( 50,k,1,1,1,i);
            utdata3(j,:) = seriell( 100,k,1,1,1,i);
        j = j + 1;
    end
    figure(11)
...
if 0 %convergencekriteria: ant vs tol for different m, function 2
    ...
    for i = p
            utdata1(j,:) = seriell(10,k,1,1,2,i);
            utdata2(j,:) = seriell( 50,k,1,1,2,i);
            utdata3(j,:) = seriell( 100,k,1,1,2,i);
        j = j + 1;
...
if 0 %convergencekriteria: ant vs tol for different k, function 1 % Merkelig
    ...
    for i = p
        utdata1(j,:) = seriell( m,10,1,1,1,i);
        utdata2(j,:) = seriell( m,50,1,1,1,i);
        utdata3(j,:) = seriell( m,100,1,1,1,i);
        j = j + 1;
    end
    figure(15)
    semilogx(p,utdata1(:,1),'k:o')
...
if 0 %convergencekriteria: ant vs tol for different k, function 2
    ...
    for i = p
        utdata1(j,:) = seriell( m,10,1,1,2,i);
        utdata2(j,:) = seriell( m,50,1,1,2,i);
        utdata3(j,:) = seriell( m,100,1,1,2,i);
        j = j + 1;
