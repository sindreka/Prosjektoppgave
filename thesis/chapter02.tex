...
q'(t) -A q(t) = P(t)
\end{equation}
for $q(t)$, without using KPM. Let $P(t)$ be as in section \ref{sec:nonsep} and denote the method DM for direct method. Note that it is not possible to use more than one processing unit on this problem.
%\newpage