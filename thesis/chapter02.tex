...
Since $h_{n+1,n} = 0$ for some $n \leq m$, this shows the finite termination of the procedure. %Note that this means that $q_n$ is an approximation to $q$.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Restarting the Krylov projection method} \label{sec:rest}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
If $n < m$ so that $h_{n+1,n} \neq 0$, we can to restart the procedure described above. Consider first the following equation
