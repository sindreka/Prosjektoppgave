...
For separable $p$, we will in general be looking at computation time and error, and how this scale with $\delta$. When $p$ is not separable we are still interested in convergence, and computation time, but also parallel efficiency. \\
